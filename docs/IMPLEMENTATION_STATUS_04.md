...
### 5. M4 daily — завершён на GPU
- 30 daily рядов
- 8 моделей (без Autoformer/FEDformer — слишком медленны на длинных рядах)
- 50 эпох
- GPU 2, tmux сессия `m4_daily`
- Время: ~4.5ч
- **0 crashes**
- Файл: `src/outputs/m4_benchmark_daily/metrics.csv`
...
### M4 Daily — sMAPE (30 рядов, 8 моделей)
...
| Autoformer | 29.3 | 14.6 | 24.7 | 34.2 | 33.9 | — |
| FEDformer | 27.8 | 16.9 | 26.6 | 37.0 | 29.9 | — |
...
2. **Autoformer/FEDformer слабые** — нужно честно объяснить почему (короткие ряды, per-series training без pretrain)
3. **M4 daily без Autoformer/FEDformer** — неполное сравнение, нужно упомянуть в тексте
4. **Литература** — катастрофически мало (7 источников)
